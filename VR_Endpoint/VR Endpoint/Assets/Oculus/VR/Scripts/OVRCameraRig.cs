...
public class OVRCameraRig : MonoBehaviour
{
	...
	private string headDataPath;
	public Boolean useFakeHeadData;
	public Boolean recordFakeHeadData;
	...
	protected virtual void Start()
	{
		...
		headDataPath = Application.persistentDataPath + @"\headsample.txt";
		if (recordFakeHeadData) sw = new StreamWriter(headDataPath, true);
		else if(useFakeHeadData) sr = new StreamReader(headDataPath);
		Debug.Log(headDataPath);
	}
